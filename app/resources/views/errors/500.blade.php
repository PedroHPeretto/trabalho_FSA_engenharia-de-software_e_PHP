...
<head>
    ...
    <title>500 — Erro Interno · Sistema de Biblioteca</title>
...
<main class="flex-1 flex items-center justify-center px-4 py-16">
    <div class="text-center max-w-md">
        ...
        <p class="text-5xl font-extrabold text-red-200 select-none leading-none">500</p>
        <h1 class="mt-4 text-2xl font-bold text-gray-800">Erro interno do servidor</h1>
        <p class="mt-3 text-gray-500 text-sm leading-relaxed">
            Algo deu errado no servidor. Nossa equipe já foi notificada.<br>
